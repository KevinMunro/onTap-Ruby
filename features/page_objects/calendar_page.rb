class CalendarPage < SitePrism::Page
  ...
  element :attending_event_succesful, "div.alert-success"
  element :request_to_attend_sent, "div[text='/A request has been sent to attend the event: (.*) /i']"
  element :request_to_attend_recieved, "div[text='/(.*) is requestingDSFADSFDSAFDSAFDSAFDSA to attend the event (.*) /i']"
